...
//  Proyecto3D
//
//  Created by Arturo Garcia on 21/05/18.
...
float xobj=0,yobj=0,xpant=0,ypant=0,x2=0,y2=0,angr,paso=1.1;  //variables camara y objetivo
...
void display(void)
{
    ...
    gluLookAt(x2,100,y2+100,       // posicion de camara
